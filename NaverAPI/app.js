...
var app = express();
var client_id = 'b3Ab9CwPhF58SdcqdTMR';
var client_secret = 'GlLoahIAI0';
...
//   var api_url = 'https://openapi.naver.com/v1/search/local.xml?query=' + encodeURI(req.query.query); // xml 결과
